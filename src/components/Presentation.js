        ...
        <div>
          <h1 style={presentationTitreStyle}>Qui suis-je ?</h1>
            <div style={presentationStyle}>
              ...
              <p> IMPORTANT : Il s'agit de la version Beta du site. Il peut y avoir des dysfonctionnements, notamment sur la 'responsivité' du site. Je vous prie de m'excuser.</p>
